...
const OrdersManager = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const res = await axios.get("https://your-backend.vercel.app/api/orders");
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    try {
      ...
      const res = await axios.put(
        `https://your-backend.vercel.app/api/orders/${orderId}/status`,
        { status: newStatus }
      );
  ...
  const handleDelete = async (orderId) => {
    ...
    try {
      await axios.delete(`https://your-backend.vercel.app/api/orders/${orderId}`);
